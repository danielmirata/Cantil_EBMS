...
<head>
    ...
    <title>Cantil E-System - Services</title>
...
<body>
    <div class="container d-flex flex-column align-items-center justify-content-center min-vh-100">
        <div class="landing-card w-100" style="max-width: 420px;">
            ...
            <a href="{{ route('resident.requestdocs') }}" class="btn main-btn main-btn-red w-100 mb-2">Request Barangay Docs</a>
            <a href="{{ route('resident.complain') }}" class="btn main-btn main-btn-outline w-100">Send Complain</a>
