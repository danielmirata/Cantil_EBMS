...
<head>
    ...
    <title>Barangay Cantil-E - New Walk-in Record</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="dashboard-header">
            <h1 class="dashboard-title">New Walk-in Record</h1>
            <div class="dashboard-subtitle">Add a new walk-in request or clearance record</div>
        </div>

        <!-- Create Form -->
        <div class="content-card mt-4">
            <form action="{{ route('secretary.records.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control @error('resident_name') is-invalid @enderror" 
                               id="resident_name" name="resident_name" value="{{ old('resident_name') }}" required>
                        @error('resident_name')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('request_type') is-invalid @enderror" 
                            ...
                            <option value="clearance" {{ old('request_type') == 'clearance' ? 'selected' : '' }}>Clearance</option>
                            <option value="certification" {{ old('request_type') == 'certification' ? 'selected' : '' }}>Certification</option>
