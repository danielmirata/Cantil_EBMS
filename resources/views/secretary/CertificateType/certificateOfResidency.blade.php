    ...
    <div class="container mt-4 mb-4">
        <div class="certificate position-relative">
            ...
            <div class="content-text">
                ...
                <p>THIS IS TO CERTIFY THAT, <span class="underline">{{ $cert->first_name . ' ' . $cert->last_name }}</span> of legal age, single/married, Filipino, is a <strong>resident of Address</strong> <span class="underline">{{ $cert->address }}</span> Barangay Cantil-e Dumaguete City, Negros Oriental. And according to our record he/she is a person with good moral character with no pending case against him/her in the barangay.</p>
