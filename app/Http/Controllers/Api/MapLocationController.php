...
class MapLocationController extends Controller
{
    public function store(Request $request)
    {
        try {
            ...
            // Check if household is already mapped
            if ($validated['household_id']) {
                $existingLocation = MapLocation::where('household_id', $validated['household_id'])->first();
                if ($existingLocation) {
                    return response()->json([
                        'error' => 'This household is already mapped on the system.',
